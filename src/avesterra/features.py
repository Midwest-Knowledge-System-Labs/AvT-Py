...
def insert_feature(
    ...
    >>> import avesterra.features as features # Insert feature at specific index
...
def remove_feature(
    ...
    >>> import avesterra.features as features # Remove feature at specific index
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def replace_feature(
    ...
    >>> import avesterra.features as features # Replace feature at specific index
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def find_feature(
    ...
    >>> import avesterra.features as features # Find feature by name
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def include_feature(
    ...
    >>> import avesterra.features as features # Include feature with unique key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def exclude_feature(
    ...
    >>> import avesterra.features as features # Exclude feature by key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def set_feature(
    ...
    >>> import avesterra.features as features # Set feature value
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def get_feature(
    ...
    >>> import avesterra.features as features # Get an existent feature
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.features as features # Attempt to get a non-existent feature
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def clear_feature(
    ...
    >>> import avesterra.features as features # Clear feature value
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_count(
    ...
    >>> import avesterra.features as features # Count features
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 1", key="key_1", value=AvValue.encode_text("Value 1"), authorization=authorization)
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 2", key="key_2", value=AvValue.encode_text("Value 2"), authorization=authorization)
...
def feature_member(
    ...
    >>> import avesterra.features as features # Check feature membership
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_name(
    ...
    >>> import avesterra.features as features # Get feature name by key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_key(
    ...
    >>> import avesterra.features as features # Get feature key by index
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_value(
    ...
    >>> import avesterra.features as features # Get feature value by key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_index(
    ...
    >>> import avesterra.features as features # Get feature index by key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def feature_attribute(
    ...
    >>> import avesterra.features as features # Get feature attribute by key
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def sort_features(
    ...
    >>> import avesterra.features as features # Sort features
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
...
def erase_features(
    ...
    >>> import avesterra.features as features # Erase all features
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 1", key="key_1", value=AvValue.encode_text("Value 1"), authorization=authorization)
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 2", key="key_2", value=AvValue.encode_text("Value 2"), authorization=authorization)
...
def retrieve_features(
    ...
    >>> import avesterra.features as features # Retrieve features as JSON
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports features
    >>> authorization: AvAuthorization
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 1", key="key_1", value=AvValue.encode_text("Value 1"), authorization=authorization)
    >>> features.include_feature(entity=entity, attribute=AvAttribute.EXAMPLE, name="Feature 2", key="key_2", value=AvValue.encode_text("Value 2"), authorization=authorization)
