...
def insert_attribution(
    ...
    >>> import avesterra.attributions as attributions # Insert attribute using `attribute`
    ...
    >>> import avesterra.attributions as attributions # Insert attribute into `index`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
...
def remove_attribution(
    ...
    >>> import avesterra.attributions as attributions # Remove last attribute from `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.insert_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(4), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Remove attribute at `index` 2 from `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.insert_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(4), authorization=authorization)
...
def replace_attribution(
    ...
    >>> import avesterra.attributions as attributions # Replace last attribute on `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.insert_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
...
def include_attribution(
    ...
    >>> import avesterra.attributions as attributions # Include new attribute
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.attributions as attributions # Overwrite previously included attribute
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
...
def set_attribution(
    ...
    >>> import avesterra.attributions as attributions # Set attribute
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.attributions as attributions # Overwrite attribute with new value
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
...
def get_attribution(
    ...
    >>> import avesterra.attributions as attributions # Get attribute
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Get non-existent attribute
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
...
def clear_attribution(
    ...
    >>> import avesterra.attributions as attributions # Clear attribute `attribute` value
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
...
def attribute_count(
    ...
    >>> import avesterra.attributions as attributions # Get attribute count on `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Get attribute count on `entity` with no attributions
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> print(attributions.attribute_count(entity=entity, authorization=authorization))
    0
...
def attribute_member(
    ...
    >>> import avesterra.attributions as attributions # Check if `attribute` exists on `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Check if non-existent `attribute` exists on `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Check if `attribute` exists on `entity` with no attributions
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> print(attributions.attribute_member(entity=entity, attribute=AvAttribute.HEIGHT, authorization=authorization))
    False
...
def attribute_name(
    ...
    >>> import avesterra.attributions as attributions # Get name of `attribute`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Get name of attribute at `index`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
...
def attribute_value(
    ...
    >>> import avesterra.attributions as attributions # Get value of attribute at `attribute`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
...
def attribute_index(
    ...
    >>> import avesterra.attributions as attributions # Get index of attribute at `attribute`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    ...
    >>> import avesterra.attributions as attributions # Get index of attribute at `index`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.WIDTH, value=AvValue.encode_integer(2), authorization=authorization)
...
def sort_attributions(
    ...
    >>> import avesterra.attributions as attributions # Sort attributions by ordinal value in Taxonomy
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.WIDTH, value=AvValue.encode_integer(2), authorization=authorization)
...
def erase_attributions(
    ...
    >>> import avesterra.attributions as attributions # Erase all attributions on `entity`
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports attributions
    >>> authorization: AvAuthorization
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.HEIGHT, value=AvValue.encode_integer(1), authorization=authorization)
    >>> attributions.set_attribution(entity=entity, attribute=AvAttribute.WIDTH, value=AvValue.encode_integer(2), authorization=authorization)
