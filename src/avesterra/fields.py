...
def insert_field(
    ...
    >>> import avesterra.fields as fields # Insert field at specific index
...
def remove_field(
    ...
    >>> import avesterra.fields as fields # Remove field at specific index
...
def replace_field(
    ...
    >>> import avesterra.fields as fields # Replace existing field
    >>> entity: AvEntity # Assume entity has existing fields
    >>> authorization: AvAuthorization
...
def find_field(
    ...
    >>> import avesterra.fields as fields # Find field with specific value
    ...
    >>> import avesterra.fields as fields # Attempt to find non-existent field value
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def include_field(
    ...
    >>> import avesterra.fields as fields # Include field if not present
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def exclude_field(
    ...
    >>> import avesterra.fields as fields # Exclude field if present
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def set_field(
    ...
    >>> import avesterra.fields as fields # Set field value
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def get_field(
    ...
    >>> import avesterra.fields as fields # Get existing field value
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.fields as fields # Attempt to get non-existent field
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def clear_field(
    ...
    >>> import avesterra.fields as fields # Clear field value
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_count(
    ...
    >>> import avesterra.fields as fields # Count all fields
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_member(
    ...
    >>> import avesterra.fields as fields # Check if field exists
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.fields as fields # Check for non-existent field
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_name(
    ...
    >>> import avesterra.fields as fields # Get field name by index
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_key(
    ...
    >>> import avesterra.fields as fields # Get field key by name
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_value(
    ...
    >>> import avesterra.fields as fields # Get field value by name
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
    ...
    >>> import avesterra.fields as fields # Get field value by index
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def field_index(
    ...
    >>> import avesterra.fields as fields # Get field index by name
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
    >>> fields.insert_field(entity=entity, name="FirstField", value=AvValue.encode_text("Value1"), index=1, authorization=authorization)
    >>> fields.insert_field(entity=entity, name="SecondField", value=AvValue.encode_text("Value2"), index=2, authorization=authorization)
...
def field_attribute(
    ...
    >>> import avesterra.fields as fields # Get field attribute by name
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def sort_fields(
    ...
    >>> import avesterra.fields as fields # Sort fields
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def erase_fields(
    ...
    >>> import avesterra.fields as fields # Erase all fields
    >>> entity: AvEntity
    >>> authorization: AvAuthorization
...
def retrieve_fields(
    ...
    >>> import avesterra.fields as fields # Retrieve all fields
    >>> entity: AvEntity # Assume entity is connected to an outlet that supports fields
    >>> authorization: AvAuthorization
