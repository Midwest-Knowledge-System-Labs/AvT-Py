...
"""
from avial.avesterra import NULL_VALUE, AuthorizationError
from avial.avesterra import AvAttribute, AvEntity, AvialModel
from avial.machinations.control_surface import create_control_surface
...
from avial.avesterra.avesterra import AdapterError, AvAuthorization
from adapter.adapter import Adapter
from avial.orchestra.interface import Interface, Method, ValueType
import midwksl
...
class _RoutableAdapter(Adapter):
    ...
    def setup_outlet(self):
        ...
        avial.avesterra.av_log.success("Successfully stored interface in outlet")
...
class RoutableAdapter:
    ...
    def generate_interface(self):
        ...
        """
        import avial.avesterra.objects as objects
    ...
    def invoke_callback(self, args: av.InvokeArgs) -> av.AvValue:
        for route in self._routes.values():
            ...
            avial.avesterra.av_log.info(f"calltimer {route._method.name}: Success in {dt:.3f}s")
            return res
